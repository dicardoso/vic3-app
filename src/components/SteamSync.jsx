  ...
  return (
    <div className="flex items-center gap-2 relative">
      ...
      <button
        ...
        className={`flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-colors min-w-[160px] ${status === 'loading' ? 'bg-slate-700 text-slate-400 cursor-not-allowed' :
